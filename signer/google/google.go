...
// GoogleSigner is a Google Cloud KMS signer.
type GoogleSigner struct {
	client  KeyManagementClient
	keyName string
}

// NewGoogleSigner creates a new Google Cloud KMS signer.
func NewGoogleSigner(client KeyManagementClient, keyName string) *GoogleSigner {
	return &GoogleSigner{client: client, keyName: keyName}
}
...
func (g *GoogleSigner) Sign(ctx context.Context, message []byte) ([]byte, error) {
