...
// NewLocalVerifier creates a new verifier with local public key.
func NewLocalVerifier(key *rsa.PublicKey) LocalVerifier {
	return LocalVerifier{key: key}
}
...
func (l LocalVerifier) Verify(ctx context.Context, message, signature []byte) error {
